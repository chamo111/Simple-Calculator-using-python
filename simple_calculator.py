...
root.geometry("570x600+100+200") #calculator size
root.resizable(False, False)
root.configure(bg="#17161b") #background color
...
Button(root,text='C', width=5, height=1, font=("arial",30,"bold"), bd=1, fg="#fff", bg="#00008B",command=lambda: clear()).place(x=10,y=100)
...
Button(root,text='=', width=5, height=3, font=("arial",30,"bold"), bd=1, fg="#fff", bg="#8B0000",command=lambda: calculate()).place(x=430,y=400)
